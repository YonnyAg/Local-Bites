        ...
        <footer className="bg-gray-800 text-white py-6">
            <div className="footer-container flex flex-wrap justify-around max-w-5xl mx-auto p-5">
                ...
                <div className="footer-column flex-1 min-w-[250px] m-4">
                    <h3 className="text-yellow-400 mb-4 text-xl font-semibold">Acerca de Nosotros</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>

                {/* Enlaces Rápidos */}
                <div className="footer-column flex-1 min-w-[250px] m-4">
                    <h3 className="text-yellow-400 mb-4 text-xl font-semibold">Enlaces Rápidos</h3>
                    <ul className="space-y-2">
                        <li><a href="index.html" className="hover:text-yellow-400">Inicio</a></li>
                        <li><a href="#" className="hover:text-yellow-400">Restaurantes</a></li>
                ...
                <div className="footer-column flex-1 min-w-[250px] m-4">
                    ...
                    <ul className="flex space-x-4">
                        <li>
                            <a href="#" className="social-btn facebook w-10 h-10 rounded-full bg-gray-600 flex items-center justify-center hover:bg-blue-600 transition-colors" aria-label="Facebook">
                                {/* Icono de Facebook */}
                        ...
                        <li>
                            <a href="#" className="social-btn twitter w-10 h-10 rounded-full bg-gray-600 flex items-center justify-center hover:bg-blue-400 transition-colors" aria-label="Twitter">
                                {/* Icono de Twitter */}
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                        ...
                        <li>
                            <a href="#" className="social-btn instagram w-10 h-10 rounded-full bg-gray-600 flex items-center justify-center hover:bg-pink-500 transition-colors" aria-label="Instagram">
                                {/* Icono de Instagram */}
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <div className="footer-bottom text-center pt-5 border-t border-gray-600">
                <p className="text-gray-400">&copy; {year} Mi Sitio Web. Todos los derechos reservados.</p>
            </div>
        </footer>
    );
};
